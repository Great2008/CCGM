...
export default function Newsletter() {
  ...
  return (
    <>
      ...
      />
      <div style={{
        background: 'linear-gradient(160deg,rgba(10,38,18,0.93) 0%,rgba(22,100,52,0.87) 55%,rgba(22,163,74,0.45) 100%),url("/images/bg/newsletter-hero.jpg") center/cover no-repeat',
