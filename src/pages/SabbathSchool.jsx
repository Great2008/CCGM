...
export default function SabbathSchool() {
  ...
  return (
    ...
    <div style={{ overflowX: 'hidden', width: '100%' }}>
      ...
      {/* Hero */}
      <div className="ss-hero" style={{ background: 'linear-gradient(160deg,rgba(10,38,18,0.93) 0%,rgba(22,100,52,0.87) 55%,rgba(22,163,74,0.45) 100%),url("/images/bg/sabbath-hero.jpg") center/cover no-repeat', padding: 'clamp(90px,14vw,130px) 5% 56px', textAlign: 'center' }}>
